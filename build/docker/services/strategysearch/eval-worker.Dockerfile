...
COPY internal/services/strategysearch/eval-worker/requirements.txt /tmp/requirements.txt
...
COPY internal/services/strategysearch/_common/ /app/
COPY internal/services/strategysearch/eval-worker/ /app/
RUN rm -rf /app/tests

# HTTP /metrics, /healthz, /readyz (STRATEGYSEARCH_METRICS_ADDR, по умолчанию :9107)
EXPOSE 9107
