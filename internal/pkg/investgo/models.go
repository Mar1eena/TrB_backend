...
func (p *GetBankAccountsResponse) GetHeader() metadata.MD {
	return p.Header
}
...
func (p *CurrencyTransferResponse) GetHeader() metadata.MD {
	return p.Header
}
...
func (p *PayInResponse) GetHeader() metadata.MD {
	return p.Header
}

type GetAccountValuesResponse struct {
	*pb.GetAccountValuesResponse
	Header metadata.MD
}

func (p *GetAccountValuesResponse) GetHeader() metadata.MD {
	return p.Header
}
...
type StructuredNoteByResponse struct {
	*pb.StructuredNoteResponse
	Header metadata.MD
}

func (p *StructuredNoteByResponse) GetHeader() metadata.MD {
	return p.Header
}
...
func (p *StructuredNotesResponse) GetHeader() metadata.MD {
	return p.Header
}
...
func (p *DfaResponse) GetHeader() metadata.MD {
	return p.Header
}

type DfasResponse struct {
	*pb.DfasResponse
	Header metadata.MD
}

func (p *DfasResponse) GetHeader() metadata.MD {
	return p.Header
}
